...
class BetterrateGenerator < ActiveRecord::Generators::Base
  ...
  def copying
    copy_file 'jquery.raty.js.erb', 'app/assets/javascripts/jquery.raty.js.erb'
    ...
    copy_file 'betterrate.js.erb', 'app/assets/javascripts/betterrate.js.erb'
  ...
  def create_betterrate_migration
